  ...
  if(stLoRa.byEstadoTrataComandos == AGUARDANDO_ENVIO_DE_COMANDO)
  {
    ...
    switch (enLoRaEstadoAtual)
    {
      ...
      case enLoRaEstado_MAC_SET_DEVADDR:
      {
        ...
        //sprintf((char *)byBufferUART2Tx, "mac set devaddr 001AD3ED\r\n"); //-- VAGON
        stLoRa.wTimeOutResposta = 2;
        break;
      }
...
//      case enLoRaEstado_MAC_SET_DEVEUI:
//      {
//        sprintf((char *)byBufferUART2Tx, "mac set deveui 0004A30B001AD3EF\r\n");
//        stLoRa.wTimeOutResposta = 2;
//        break;
//      }
//
//      case enLoRaEstado_MAC_SET_APPEUI:
//      {
//        sprintf((char *)byBufferUART2Tx, "mac set appeui 0000000000000000\r\n");
//        stLoRa.wTimeOutResposta = 2;
//        break;
//      }
//
//      case enLoRaEstado_MAC_SET_APPKEY:
//      {
//        sprintf((char *)byBufferUART2Tx, "mac set appkey 11111111111111111111111111111111\r\n");
//        stLoRa.wTimeOutResposta = 2;
//        break;
//      }
//
//      case enLoRaEstado_MAC_JOIN_OTAA:
//      {
//        sprintf((char *)byBufferUART2Tx, "mac join otaa\r\n");
//        stLoRa.wTimeOutResposta = 30;
//        byTemRespostaIntermediaria = TRUE;
//      break;
//      }
      ...
      case enLoRaEstado_MAC_TX_CNF:
      {
        ...
        {
          //sprintf((char *)byBufferUART2Tx, "mac tx cnf 1 EEFF5A\r\n");
  ...
  {
    if(stLoRa.byEstadoTrataComandos == AGUARDANDO_RESPOSTA)
    {
...
//    case enLoRaEstado_MAC_SET_DEVEUI:
//    {
//      LORA_VerificaRespostaLoRa(enLoRaEstado_MAC_SET_APPEUI, enLoRaEstado_SYS_RESET, 3);
//      break;
//    }
//
//    case enLoRaEstado_MAC_SET_APPEUI:
//    {
//      LORA_VerificaRespostaLoRa(enLoRaEstado_MAC_SET_APPKEY, enLoRaEstado_SYS_RESET, 3);
//      break;
//    }
//
//    case enLoRaEstado_MAC_SET_APPKEY:
//    {
//      LORA_VerificaRespostaLoRa(enLoRaEstado_MAC_JOIN_OTAA, enLoRaEstado_SYS_RESET, 3);
//      break;
//    }
//
//    case enLoRaEstado_MAC_JOIN_OTAA:
